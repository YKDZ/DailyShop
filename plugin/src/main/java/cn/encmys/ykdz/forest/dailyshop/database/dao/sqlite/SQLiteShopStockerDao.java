...
import cn.encmys.ykdz.forest.dailyshop.api.database.dao.ShopStockerDao;
...
public class SQLiteShopStockerDao implements ShopStockerDao {
    ...
    @Override
    public ShopStockerSchema querySchema(String shopId) {
    ...
    @Override
    public void insertSchema(ShopStockerSchema schema) {
        try (Connection conn = DailyShop.DATABASE_FACTORY.getConnection()) {
    ...
    @Override
    public void updateSchema(ShopStockerSchema schema) {
        try (Connection conn = DailyShop.DATABASE_FACTORY.getConnection()) {
    ...
    @Override
    public void deleteSchema(ShopStockerSchema schema) {
        try (Connection conn = DailyShop.DATABASE_FACTORY.getConnection()) {
